<template>
  <div class="tvShowLibraryPageContainer">
    <div class="header">
      <div class="tvShowFilter">
...
const { cardsNumPerPage, tvShowLibraryPageLilterItems: filterItems } = storeToRefs(useMainStore()); 
</script>
<style scoped>
.tvShowLibraryPageContainer {
  position: relative;
    left: 15px;
  top: 20px;
}
